...
//only use this if ItemType = std::string
//#include <string>
...
public:
    ...
    Sequence(int size = DEFAULT_MAX_ITEMS);    // Create a new sequence
    ...
    void dump() const;
    //prints out the contents of the sequence in the form:
    //"the sequence contains: 'item 1', 'item 2', 'item 3', etc."
